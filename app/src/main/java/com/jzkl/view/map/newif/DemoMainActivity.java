 ...
 */
package com.jzkl.view.map.newif;
...
//         BaiduNaviManagerFactory.getTTSManager().initTTS(mTTSCallback);
    ...
    private void routeplanToNavi(final int coType) {
        ...
        BNRoutePlanNode sNode = new BNRoutePlanNode(112.561156,37.84606, "山西财经大学", "山西财经大学", coType);
        BNRoutePlanNode eNode = new BNRoutePlanNode(112.560366,37.813683, "凯通大厦", "凯通大厦", coType);
        mStartNode = sNode;
